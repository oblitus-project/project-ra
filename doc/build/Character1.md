...
### 燃烧热血
不会因[[doc/build/keyword/effect#烧伤 X|烧伤]]使体力低于**上限 10%** 或使混乱抗性低于**上限 20%**。
...
[命中时] 
- 使目标手中**耗能不高于 3** 的卡牌费用+1 （使用 1 次后失效）；
...
> [!tip] 部分卡牌可能不止消耗 [[library#COST|COST]]。（`/`用于在其间分隔。）
...
##### 闪避 4-10 | Lv+2
[成功闪避时] 恢复 6 点体力与 2 点[[library#理智 / Sanity|理智]]。
...
#### 推迟
0 [[library#COST|COST]] | [[doc/build/keyword/mechanism#技能卡|技能卡]] | 普通 | x2 | 懒惰 I
...
自身每失去**上限 1%** 体力，使[[doc/build/keyword/effect#伤害率增加 X%|伤害率增加 1%]]。
...
### 不屈
首次[[library#陷入混乱|陷入混乱]]时，解除混乱，并恢复**上限 50%** 混乱抗性；
**当前回合混乱抗性不会低于 1 点。**
...
### 燃烧热血
[回合开始] 自身拥有[[doc/build/keyword/effect#烧伤 X|烧伤]]时，切换为==EIS:: 见微色霸气==形态；——若自身已没有[[doc/build/keyword/effect#烧伤 X|烧伤]]，退出==EIS::见微色霸气==形态；
不会因[[doc/build/keyword/effect#烧伤 X|烧伤]]使体力低于**上限 10%** 或使混乱抗性低于**上限 20%**。
...
### 盛怒
[仅在处于 EIS::见微色霸气 形态下触发]
[命中时] 下回合获得 1 层[[doc/build/keyword/effect#烧伤 X|烧伤]]。（每张卡牌最多 3 次）
...
### 再撑一会
[开启战斗] 2 回合内：
- [回合开始] 获得[[doc/build/keyword/effect#承伤率降低 X%|承伤率降低 30%]]。

---

## [[library#理智 / Sanity|理智]]
### [[library#士气低落|士气低落]] | 坚持
**自身受到致死伤害时，无视该伤害，本回合体力不会低于 1 点，也不会[[library#陷入混乱|陷入混乱]]。**（每场战斗仅 1 次。）
[回合开始] 若自身体力不高于上限 10% ，消耗 2 层烧伤并恢复上限 5% 的体力。
...
**本卡牌的 COST 耗能不会高于 2**。
##### 近战 6-10 | 突刺 Lv+0
[命中时] 使目标**手中 2 张耗能不超过 2 的卡牌**耗能+1。
##### 招架 5-8 | Lv+1
若目标使用了攻击骰子，使本骰子威力+2。
